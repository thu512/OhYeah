package com.gogolab.ohyeah.utill;
...
public class U {
    ...
    {
        SharedPreferences.Editor editor = context.getSharedPreferences("badge", 0).edit();
        editor.putInt(key, value);
        editor.commit();
    }
    public int getInt(Context context, String key)
    {
        return context.getSharedPreferences("badge", 0).getInt(key, 0);
    }
